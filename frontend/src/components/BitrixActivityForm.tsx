...
const BitrixActivityForm = ({ companies, employees, onSubmit, preSelectedStatus, onCancel, initialData }: BitrixActivityFormProps) => {
  ...
  const [formData, setFormData] = useState({
    ...
    status: initialData?.status || preSelectedStatus || 'pending',
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        ...
        <Select value={formData.status} onValueChange={(value) => setFormData({ ...formData, status: value })}>
          ...
          <SelectContent>
            <SafeSelectItem value="pending">Aberto</SafeSelectItem>
            <SafeSelectItem value="in_progress">Em Progresso</SafeSelectItem>
            <SafeSelectItem value="completed">Concluído</SafeSelectItem>
            <SafeSelectItem value="cancelled">Cancelado</SafeSelectItem>
          </SelectContent>
        </Select>
      </div>
