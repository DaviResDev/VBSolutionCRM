...
import { Search, Filter, Bell, MessageCircle, User, Settings, Sun, Moon, LogOut } from 'lucide-react';
        ...
        <div className="flex items-center gap-6 flex-1 justify-center">
          ...
          <div className="relative w-64 md:w-80">
            ...
            <input
              ...
              className="pl-10 pr-3 py-1 w-full border rounded-md text-sm h-8 transition-all duration-200 [&::placeholder]:text-gray-500"
              style={{
