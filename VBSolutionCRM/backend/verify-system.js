...
/**
 * 🛡️ SCRIPT DE VERIFICAÇÃO DO SISTEMA DE PROTEÇÃO
 * 
...
async function verifyDatabase() {
  ...
  try {
    ...
    if (messages.length > 0) {
      ...
      const requiredColumns = ['message_type', 'media_type', 'conteudo', 'atendimento_id'];
...
async function main() {
  log(`${COLORS.BOLD}🛡️ VERIFICAÇÃO DO SISTEMA DE PROTEÇÃO${COLORS.RESET}`, COLORS.BLUE);
